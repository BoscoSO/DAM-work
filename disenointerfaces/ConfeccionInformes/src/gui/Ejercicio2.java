...
public class Ejercicio2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "UK", "USA", "Brasil" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            parametros.put("pais", jComboBox1.getSelectedItem());
            
            JasperPrint print = JasperFillManager.fillReport("informes/informeEjercicio2.jasper",
            parametros, conexion);
            // Exportar a PDF
            JasperExportManager.exportReportToPdfFile(print, "informes/suministradores"+jComboBox1.getSelectedItem()+".pdf");
